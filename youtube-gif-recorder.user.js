...
function openSettingsPanel() {
    ...
    panel.querySelector('#yt-gif-setting-save').addEventListener('click', () => {
        ...
        if (keyRecord === keyScreenshot || keyRecord === keyGif || keyScreenshot === keyGif) {
...
(function () {
    ...
    function makeVideoFileName(type, extension, title = null) {
        const videoTitle = title || getYouTubeVideoTitle();

        const timestamp = getFileTimestamp();

        return videoTitle + '_' + type + '_' + timestamp + '.' + extension;
    }
    ...
    async function startRecording() {
         ...
         */
        const recordingVideoTitle = getYouTubeVideoTitle();
        ...
        mediaRecorder.onstop = () => {
            ...
            downloadBlob(blob, makeVideoFileName('녹화', ext, recordingVideoTitle));
    ...
    async function startGifRecording() {
         ...
         */
        gifVideoTitle = getYouTubeVideoTitle();
    ...
    function createButton() {
        ...
        if (!document.getElementById('yt-screenshot-btn')) {
            ...
            shotBtn.appendChild(makeSvgIcon(g));
